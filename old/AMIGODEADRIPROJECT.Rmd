...
The table of results can be found [here](http://ieoproject.tk/ieo/gocondtests.html).
...
The table of results can be found [here](http://ieoproject.tk/ieo/goresults.html).
...
The table of results can be found [here](http://ieoproject.tk/ieo/go_overexpr_condtests.html).
...
The table of results can be found [here](http://ieoproject.tk/ieo/go_overexpr_results.html).
...
The table of results can be found [here](http://ieoproject.tk/ieo/go_underexpr_condtests.html).
...
The table of results can be found [here](http://ieoproject.tk/ieo/go_underexpr_results.html).

## Gene Set Enrichment Analysis

We can evaluate the differentially expressed GO terms for biological processes by using Gene Set Enrichment Analysis (GSEA). The gene set collection used for the analysis is obtained from the [Molecular Signatures Database](http://www.broadinstitute.org/gsea/msigdb/download_file.jsp?filePath=/resources/msigdb/5.0/c5.bp.v5.0.orig.gmt).

First of all we map identifiers from gene sets to identifiers of the data we analyze.
...
For select some of the significant pathway terms and compare the mean expression values for the two phenotypes.
...
plotGS(eset_GSEA, genesGS1, "disease_status", main = "REACTOME_CELL_SURFACE_INTERACTIONS_AT_THE_VASCULAR_WALL", cex.lab = 1, las = 1)
plotGS(eset_GSEA, genesGS2, "disease_status", main = "REACTOME_P53_INDEPENDENT_DNA_DAMAGE_RESPONSE", cex.lab = 1, las = 1)
plotGS(eset_GSEA, genesGS3, "disease_status", main = "REACTOME_SIGNALING_IN_IMMUNE_SYSTEM", cex.lab = 1, las = 1)
plotGS(eset_GSEA, genesGS4, "disease_status", main = "REACTOME_TIGHT_JUNCTION_INTERACTIONS", cex.lab = 1, las = 1)
plotGS(eset_GSEA, genesGS5, "disease_status", main = "REACTOME_HEMOSTASIS", cex.lab = 1, las = 1)
plotGS(eset_GSEA, genesGS6, "disease_status", main = "REACTOME_SLC_MEDIATED_TRANSMEMBRANE_TRANSPORT", cex.lab = 1, las = 1)
```
