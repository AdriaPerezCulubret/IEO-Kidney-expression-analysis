...
The GSEA results show 677 DE pathways. In this study we only focused on the top ones. This results can be found on supplementary materials (Fig. \href{run:./paired_project.html\#gene-set-enrichment-analysis}{S22}).
