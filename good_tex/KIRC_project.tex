...
=======
The application of this approach to the whole set of samples results in a more complex set of clusters. As we can see in Fig. 2, although almost the entire set of normal and tumour samples cluster together, some tumour samples show an unexpected clustering behaviour. These samples are closer to the cluster of normal samples, leading us to determine that these strongly DE genes do not capture the whole variability between tumour and normal samples.
>>>>>>> 62cd3488981e749099a111981e0d33e0a5798bd2
