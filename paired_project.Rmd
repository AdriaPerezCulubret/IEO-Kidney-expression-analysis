...
params <- new("GOHyperGParams", geneIds=DEgenes, universeGeneIds=geneUniverse,
            annotation="org.Hs.eg.db", ontology="BPi",
...
genesGS1 <- colnames(gsmatrix)[which(gsmatrix[names(rnkGS)[1], ] == 1)]
genesGS2 <- colnames(gsmatrix)[which(gsmatrix[names(rnkGS)[6], ] == 1)]
par(mfrow = c(1, 2), mar = c(4, 5, 3, 4))
plotGS(se.paired.gsea, genesGS1, "gender", main = names(rnkGS)[1], cex.lab = 2, las = 1)
plotGS(se.paired.gsea, genesGS2, "gender", main = names(rnkGS)[6], cex.lab = 2, las = 1)
```
