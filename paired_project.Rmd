...
ggplot(toptable) + geom_point(aes(x=logFC, y=-log10(adj.P.Val)), color="red") + theme_bw() +
geom_vline(xintercept = 5, linetype="dashed") + geom_vline(xintercept = -5, linetype="dashed") + geom_hline(yintercept = 2, linetype="dashed")
