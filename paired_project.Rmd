...
- [HIERACHICAL CLUSTERING USING DE GENES](#Hiercarchical-clustering-using-de-genes)
...
>>>>>>> 353ac55592b1f83f5b2b1156bc44cda303b60287
...
In order to identify differentially expressed genes, we used a linear model with two factors: one being the type of the sample (tumor or normal) and the other being the individual/sample.
...
params <- new("GOHyperGParams", geneIds=DEgenes, universeGeneIds=geneUniverse,
            annotation="org.Hs.eg.db", ontology="BP",
            pvalueCutoff=0.01, testDirection="under")
