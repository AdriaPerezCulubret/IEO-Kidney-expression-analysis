...
genesGS1 <- colnames(gsmatrix)[which(gsmatrix[names(rnkGS)[37], ] == 1)]
genesGS2 <- colnames(gsmatrix)[which(gsmatrix[names(rnkGS)[26], ] == 1)]
par(mfrow = c(1, 2), mar = c(4, 5, 3, 4))
plotGS(se.paired.gsea, genesGS1, "type", main = names(rnkGS)[37], cex.lab = 2, las = 1)
plotGS(se.paired.gsea, genesGS2, "type", main = names(rnkGS)[26], cex.lab = 2, las = 1)
```
