...
Parlar de lo desconegut i putes que es aquest cancer i tambe parlar de la importancia de lanalisi per donar llum als gens que caracteritzen el KIRC. Realzar la importancia de la caracterizacion de este cancer, para luego en las conclusiones decir que hemos dado luz en al caraterizacion.
